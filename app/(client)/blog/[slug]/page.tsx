    ...
    <div className='mb-10 md:mb-15'>
      <Container className='grid grid-cols-1 lg:grid-cols-4 gap-5'>
        <div className="md:col-span-3">
          ...
          <div className="bg-shop_light_bg p-5 rounded-md">
                ...
                {blog.body && (
                  <PortableText
                    ...
                    components={{
                      block: {
                        normal: ({ children }) => (
                          <p className='my-5 text-base/8 first:mt-0 last:mb-0'>{children}</p>
                        ),
                        h2: ({ children }) => (
                          <h2 className="my-5 text-2xl/8 font-medium tracking-tight text-gray-950 first:mt-0 last:mb-0">{children}</h2>
                        ),
                        h3: ({ children }) => (
                          <h3 className="my-5 text-xl/8 font-medium tracking-tight text-gray-950 first:mt-0 last:mb-0">{children}</h3>
                        ),
                        blockquote: ({ children }) => (
                          <blockquote className='my-5 border-l-2 border-l-gray-300 pl-6 text-base/8 text-gray-950 first:mt-0 last:mb-0'>{children}</blockquote>
                        )
                      },
                      types: {
                        image: ({ value }) => (
