   ...
   return (
      <div className={cn("flex flex-col items-center justify-center py-10 min-h-80 text-center rounded-lg space-y-4 bg-gray-100 w-full mt-10", className)}>
         ...
         >
            ...
            <span className="text-base font-semibold text-darkColor">{selectedTab}</span>{" "}criteria at the moment.
         </motion.p>
         ...
         >
            Please check back later or explore our other product categories for more options.
         </motion.p>
      </div>
   )
}
